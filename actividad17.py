...
fondo=tk.Frame(ventana,width=400, height=400, bg="pink")
...
boton_dividir=tk.Button(ventana,text="DIVIDIR *",command=dividir,font=("Bookman Old Style",12,"bold"),fg="turquoise",activebackground="pink")
